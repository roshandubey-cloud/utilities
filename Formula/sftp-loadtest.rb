...
class SftpLoadtest < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "1e6980d113f7e107a3adef2825afc4add390671f70f5de5314a11b97a39581f1"
    end
    on_intel do
      url "https://github.com/roshandubey-cloud/utilities/releases/download/v#{version}/sftp-loadtest-webui-v#{version}-mac-intel.zip"
      sha256 "6b97ed9d453eb4d5ad88ad3bd279cacf9dc2265dd95ed915d62477080d4692f1"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "04d20dc52300ab34218588d12583b565f61c2d7a826abaec34f671b382765af7"
    end
    on_intel do
      ...
      sha256 "f93689022de3adcf5bbdc509eea81aae198f681113d5e25800826efbb8aacc7e"
    end
  end
