...
class SftpLoadtest < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "5bf0d42282b4f0a242cdbb7e20578e4da616a02365ce33cdcf4fe6c8d8999634"
    end
    on_intel do
      url "https://github.com/roshandubey-cloud/utilities/releases/download/v#{version}/sftp-loadtest-webui-v#{version}-mac-intel.zip"
      sha256 "4732e9282097264bb04c7dab75a2335b85602ed3e41560ee6d75f96976422b4a"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "7c796426b2741f225742bb6ad42995b0d0e8f0e8752cd4911a426e9bea748690"
    end
    on_intel do
      ...
      sha256 "353ea8fc9be882038da589e7aefde7833a8cc21d6ba0dd12d4d9b6ab4342b988"
    end
  end
