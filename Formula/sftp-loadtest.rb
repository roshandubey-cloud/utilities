...
class SftpLoadtest < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "c00703b2c548bfe3fa197b84ec6e2e7834ac70a10a74f3ac99b9f4ce9db787c1"
    end
    on_intel do
      url "https://github.com/roshandubey-cloud/utilities/releases/download/v#{version}/sftp-loadtest-webui-v#{version}-mac-intel.zip"
      sha256 "55bcfd2838b2cf7c072618e3b1ad22b218beeef0b837e990d7555acc301877d6"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "f479cf78ab62845d1cab5a99262a1a122fca0b72a22535f652e2c4894efbbe98"
    end
    on_intel do
      ...
      sha256 "429a7f38b8449a356e29b95c3bfad06e144bad8bfcd51305fb0d0be2069deba9"
    end
  end
