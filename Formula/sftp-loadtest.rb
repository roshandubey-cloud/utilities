...
class SftpLoadtest < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "308141099ac3b2dba4ebbb46dbba7ca217190d9d8dc87f3ac17345f0fce60650"
    end
    on_intel do
      url "https://github.com/roshandubey-cloud/utilities/releases/download/v#{version}/sftp-loadtest-webui-v#{version}-mac-intel.zip"
      sha256 "8d0e86c87349c69305910d4e711e5e70a540da50eaa219eb1a642e830381a5f8"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "554705a235dc1e9cc93c26811abd8c8e7f369447dac70f30a639b047fe4f80b3"
    end
    on_intel do
      ...
      sha256 "af416955a507e2bb8664d400f4fc7f1d45b796c0251f753e41849bf8ec3b3645"
    end
  end
