...
class SftpLoadtest < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "57459efda0b3abe7310b76daf1a46879fb3df6811887348eb05ebf9dccf528d9"
    end
    on_intel do
      url "https://github.com/roshandubey-cloud/utilities/releases/download/v#{version}/sftp-loadtest-webui-v#{version}-mac-intel.zip"
      sha256 "19cbc1b1268bde0da7421d136b5cd2ecc89eb0640452b7b4a82ea696132ecfa9"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "330d3d88f1b1f2dbb2ad7835a773efca2486b03131b689b9dde5881092d6f4f7"
    end
    on_intel do
      ...
      sha256 "29ab1ed8cc40ad86a981b211f6b8dfb0c439f7c4a9d89799416de81da07acdc5"
    end
  end
